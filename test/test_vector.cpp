...
int test_is_unit()
{
  ...
  {
    test_vec.push_back({"is_unit( t[" + std::to_string(i) + "] )", is_unit(t[i])});
  }
...
{
  std::vector<Vec3r> v{{0, 0, 1}, {.5, .5, .5}, {.5 * sqrt(2.0), .5 * -sqrt(2.0), 1.0}};
...
{
  std::vector<Vec3r> v{{0.1, 0.0, 0.1}, {0.0, 0.1, 0.0}, {0.2, 0.2, 0.2}};
...
int test_unit_vector()
{
  ...
  TestVector test_vec{{"isnan( unit_vector( v1 ) ) == true", isnan(unit_vector(v1))}, {"is_unit( unit_vector( v2 ) ) == true", is_unit(unit_vector(v2))}, {"is_unit( unit_vector( v3 ) ) == true", is_unit(unit_vector(v3))}, {"is_unit( unit_vector( v4 ) ) == true", is_unit(unit_vector(v4))}};
